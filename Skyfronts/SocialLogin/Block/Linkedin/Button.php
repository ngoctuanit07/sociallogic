...
namespace Skyfronts\SocialLogin\Block\Linkedin;
...

{
    ...
    public function __construct(
        ...
        \Skyfronts\SocialLogin\Model\Linkedin\Oauth2\Client $clientLinkedin,
...

    {
        ...
        $this->userInfo = $this->_registry->registry('skyfronts_sociallogin_linkedin_userdetails');
    ...
    public function getButtonUrl()
    {
        if(empty($this->userInfo)) {
            ...
            return $this->getUrl('skyfrontssociallogin/linkedin/disconnect');
    ...
    {
        if(empty($this->userInfo)) {
            if(!($text = Mage::registry('skyfronts_sociallogin_button_text'))){
    ...
    {
        if(empty($this->userInfo)) {
                $text = "skyfronts_linkedin_connect";
       } else {
                $text = "skyfronts_linkedin_disconnect";
        }
        return $text;
    }
}