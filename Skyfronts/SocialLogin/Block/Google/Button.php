 ...
 * @author		CedCommerce Magento Core Team <Ced_MagentoCoreTeam@cedcommerce.com>
 */
namespace Skyfronts\SocialLogin\Block\Google;
...

{
...

    {
        ...
        $this->userInfo = $this->_registry->registry('skyfronts_sociallogin_google_userdetails');
    ...
    public function getButtonUrl()
    {
       ...
       if(empty($this->userInfo)) {
            ...
            return $this->getUrl('skyfrontssociallogin/google/disconnect');
...

    {
        ...
        if(empty($this->userInfo)) {
               ...
               $text = "skyfronts_google_connect";

        } else {

                $text = "skyfronts_google_disconnect";
        }
