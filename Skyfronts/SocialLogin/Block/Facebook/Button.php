 ...
 * @author		CedCommerce Magento Core Team <Ced_MagentoCoreTeam@cedcommerce.com>
 */
namespace Skyfronts\SocialLogin\Block\Facebook;
...

{
...

    {
        ...
        $this->userInfo = $this->_registry->registry('skyfronts_sociallogin_facebook_userdetails');
...

    {
        ...
        $userInfo = $this->_registry->registry('skyfronts_sociallogin_userinfo');
    ...
    public function getButtonUrl()
    {
        if(empty($this->userInfo)) {
           ...
           return $this->getUrl('skyfrontssociallogin/facebook/disconnect');
       }
    }
...

    {
        if(empty($this->userInfo)) {
               ...
               $text = "skyfronts_fb_connect";
        } else {
               $text = "skyfronts_fb_disconnect";
       }
