...
{
	/**
     * @var \Skyfronts\SocialLogin\Helper\Twitter
     */
     ...
     * @param \Skyfronts\SocialLogin\Helper\Twitter $helperTwitter
    ...
    public function __construct(
        ...
        \Skyfronts\SocialLogin\Helper\Twitter $helperTwitter,
...

    {
      ...
      if($this->_customerSession->getTwitterPage() && $this->_customerSession->getTwitterPage() === 'checkout'){
