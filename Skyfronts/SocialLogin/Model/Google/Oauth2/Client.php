 ...
 * @author		SkyfrontsCommerce Magento Core Team <Skyfronts_MagentoCoreTeam@cedcommerce.com>
 */
namespace Skyfronts\SocialLogin\Model\Google\Oauth2;
...

{
	...
	const REDIRECT_URI_ROUTE = 'skyfrontssociallogin/google/connect';



    const XML_PATH_ENABLED = 'customer/skyfronts_sociallogin_google/enabled';



    const XML_PATH_CLIENT_ID = 'customer/skyfronts_sociallogin_google/client_id';



    const XML_PATH_CLIENT_SECRET = 'customer/skyfronts_sociallogin_google/client_secret';
     ...
     * @var \Skyfronts\SocialLogin\Helper\Data
     ...
     * @param \Skyfronts\SocialLogin\Helper\Data $helperData
    ...
    public function __construct(
            ...
            \Skyfronts\SocialLogin\Helper\Data $helperData,
...

    {
        ...
        if($response->isError()) {
            ...
            if(($status == 400 || $status == 401)) {
                ...
                // throw new \Skyfronts\SocialLogin\Model\Google\Oauth2\Exception($message);
