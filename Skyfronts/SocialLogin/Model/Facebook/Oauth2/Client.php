 ...
 * @author		SkyfrontsCommerce Magento Core Team <Skyfronts_MagentoCoreTeam@cedcommerce.com>
 */
namespace Skyfronts\SocialLogin\Model\Facebook\Oauth2;

class Client extends \Magento\Framework\DataObject

{

    const REDIRECT_URI_ROUTE = 'skyfrontssociallogin/facebook/connect';

    const XML_PATH_ENABLED = 'customer/skyfronts_sociallogin_facebook/enabled';

    const XML_PATH_CLIENT_ID = 'customer/skyfronts_sociallogin_facebook/client_id';

    const XML_PATH_CLIENT_SECRET = 'customer/skyfronts_sociallogin_facebook/client_secret';
