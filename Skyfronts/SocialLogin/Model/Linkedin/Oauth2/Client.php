...
namespace Skyfronts\SocialLogin\Model\Linkedin\Oauth2;
...

{
    ...
    const REDIRECT_URI_ROUTE = 'skyfrontssociallogin/linkedin/connect';

    const XML_PATH_ENABLED = 'skyfrontscommerce/skyfronts_sociallogin_linkedin/enabled';

    const XML_PATH_CLIENT_ID = 'skyfrontscommerce/skyfronts_sociallogin_linkedin/client_id';

    const XML_PATH_CLIENT_SECRET = 'skyfrontscommerce/skyfronts_sociallogin_linkedin/client_secret';
